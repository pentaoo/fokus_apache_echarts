...
export function createNewUiStylePreset(
  ...
  return {
    ...
    pieLabelSize: 16,
    xAxisLabelMargin: 12,
    yAxisLabelMargin: isRows ? 0 : 14,
    showValueLabels: kind === 'columns' || kind === 'rows',
    titleAlignment: isRows || kind === 'line' ? 'left' : 'center',
    labelAlignment: isRows || kind === 'line' ? 'left' : 'center',
    ...
    barRadius: 120,
    barRoundPeaks: true,
    barMaxWidth: isRows ? 60 : 64,
    barValuePosition: isPie ? 'inside' : 'top',
    ...
    pieClockwise: true,
    pieLabelPosition: 'outside',
    showPiePercentages: isPie,
    showPieLabels: isPie,
    showPieLabelLines: isPie,
